...
% Helpful to detect undefined Unicode characters!!!
%
...
%            pagecolor=red,    % color for links to other pages
            %pagecolor=black,  % color for links to other pages   COMENTEI ISTO ???????!!!!!!!!!
...
% Places indent of the first paragraph after a section and chapter
